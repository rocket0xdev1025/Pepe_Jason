(function (e, t) {
  "function" == typeof define && define.amd
    ? define("jquery-bridget/jquery-bridget", ["jquery"], function (o) {
        return t(e, o);
      })
    ...
    function l(e, t, n) {
      ...
      return (
        e.each(function (e, i) {
          ...
          if (!d)
            return void s(
              o + " not initialized. Cannot call methods, i.e. " + l
            );
          var p = d[t];
          if (!p || "_" == t.charAt(0))
            return void s(l + " is not a valid method");
          var m = p.apply(d, n);
          r = void 0 === r ? m : r;
        }),
        void 0 === r ? e : r
  ...
  (function (e, t) {
    ...
    function r(r) {
      if (
        ...
        for (
          var p = { width: r.offsetWidth, height: r.offsetHeight },
            m = (p.isBorderBox = "border-box" == a.boxSizing),
            c = 0;
          c < d;
          c++
        ) {
        ...
        var h = p.paddingLeft + p.paddingRight,
          f = p.paddingTop + p.paddingBottom,
          ...
          E = m && s,
          b = e(a.width);
        !1 !== b && (p.width = b + (E ? 0 : h + v));
        var z = e(a.height);
        return (
          !1 !== z && (p.height = z + (E ? 0 : f + S)),
          (p.innerWidth = p.width - (h + v)),
          (p.innerHeight = p.height - (f + S)),
        ...
        return (
          e.forEach(function (e) {
            if (s(e)) {
              ...
              t(e, n) && r.push(e);
              for (var o = e.querySelectorAll(n), a = 0; a < o.length; a++)
                r.push(o[a]);
            }
          }),
          r
      ...
      (o.htmlInit = function (t, i) {
        o.docReady(function () {
          var r = o.toDashed(i),
            ...
            d = o.makeArray(a).concat(o.makeArray(l)),
            p = e.jQuery;
          d.forEach(function (e) {
            var o,
              r = e.getAttribute(s) || e.getAttribute(s + "-options");
            try {
              o = r && JSON.parse(r);
            } catch (t) {
              return void (
                n &&
                n.error("Error parsing " + s + " on " + e.className + ": " + t)
              );
            }
            var a = new t(e, o);
            p && p.data(e, i, a);
  ...
  (function (e, t) {
    ...
    (d.constructor = i),
      ...
      (d.layoutPosition = function () {
        ...
        var l = i ? "paddingTop" : "paddingBottom",
          d = i ? "top" : "bottom",
          p = i ? "bottom" : "top",
          m = this.position.y + e[l];
        (t[d] = this.getYValue(m)),
          (t[p] = ""),
          this.css(t),
      ...
      (d.getXValue = function (e) {
        ...
        return this.layout.options.percentPosition && !t
          ? 100 * (e / this.layout.size.width) + "%"
          : e + "px";
      }),
      (d.getYValue = function (e) {
        var t = this.layout._getOption("horizontal");
        return this.layout.options.percentPosition && t
          ? 100 * (e / this.layout.size.height) + "%"
          : e + "px";
      }),
      (d._transitionTo = function (e, t) {
        ...
        var r = {};
        (r.transform = this.getTranslate(e - o, t - i)),
          this.transition({
            to: r,
      ...
      (d.transition = function (e) {
        ...
        for (o in e.to)
          (t.ingProperties[o] = !0), e.isCleaning && (t.clean[o] = !0);
        if (e.from) {
          this.css(e.from);
    ...
    (d.ontransitionend = function (e) {
      if (e.target === this.element) {
        var t = this._transn,
          i = m[e.propertyName] || e.propertyName;
        if (
          (delete t.ingProperties[i],
          o(t.ingProperties) && this.disableTransition(),
          i in t.clean &&
    ...
    return (
      ...
      (d.reveal = function () {
        ...
        (t[o] = this.onRevealTransitionEnd),
          this.transition({
            from: e.hiddenStyle,
            to: e.visibleStyle,
            isCleaning: !0,
  ...
  (function (e, t) {
    ...
    function r(e, t) {
      ...
      if (!o)
        return void (
          l &&
          l.error(
            "Bad element for " + this.constructor.namespace + ": " + (o || e)
          )
        );
      (this.element = o),
    ...
    i.extend(u, t.prototype),
      ...
      (u._positionItem = function (e, t, o, n, r) {
      ...
      (r.create = function (e, t) {
        var o = s(r);
        return (
          (o.defaults = i.extend({}, r.defaults)),
          i.extend(o.defaults, t),
          (o.compatOptions = i.extend({}, r.compatOptions)),
          (o.namespace = e),
          (o.data = r.data),
          (o.Item = s(n)),
          i.htmlInit(o, e),
          d && d.bridget && d.bridget(e, o),
          o
        );
      });
    var g = { ms: 1, s: 1e3 };
  ...
  (function (e, t) {
    "function" == typeof define && define.amd
      ? define("isotopewpr-layout/js/item", ["outlayer/outlayer"], t)
      : "object" == typeof module && module.exports
      ? (module.exports = t(require("outlayer")))
      : ((e.IsotopeWpr = e.IsotopeWpr || {}),
        (e.IsotopeWpr.Item = t(e.Outlayer)));
  })(window, function (e) {
    "use strict";
    function t() {
  ...
  (function (e, t) {
    "function" == typeof define && define.amd
      ...
      : ((e.IsotopeWpr = e.IsotopeWpr || {}),
        (e.IsotopeWpr.LayoutMode = t(e.getSize, e.Outlayer)));
  })(window, function (e, t) {
    "use strict";
    function o(e) {
      (this.isotopewpr = e),
    ...
    return (
      [
        ...
        i[e] = function () {
          return t.prototype[e].apply(this.isotopewpr, arguments);
        };
      }),
      (i.needsVerticalResizeLayout = function () {
        var t = e(this.isotopewpr.element),
          o = this.isotopewpr.size && t;
        return o && t.innerHeight != this.isotopewpr.size.innerHeight;
      }),
      ...
      (i.getSegmentSize = function (e, t) {
        ...
        if ((this._getMeasurement(o, i), !this[o])) {
          ...
          this[o] = (n && n[i]) || this.isotopewpr.size["inner" + t];
        }
      }),
      (i.getFirstItemSize = function () {
        var t = this.isotopewpr.filteredItems[0];
      ...
      (i.getSize = function () {
        this.isotopewpr.getSize(), (this.size = this.isotopewpr.size);
      }),
      (o.modes = {}),
  ...
  (function (e, t) {
    ...
    return (
      ...
      (i._getTopColPosition = function (e) {
        ...
        return { col: t.indexOf(o), y: o };
      }),
      (i._getTopColGroup = function (e) {
        if (2 > e) return this.colYs;
        for (var t = [], o = this.cols + 1 - e, n = 0; n < o; n++)
      ...
      (i._getHorizontalColPosition = function (e, t) {
        ...
        return (
          (this.horizontalColIndex = n ? o + e : this.horizontalColIndex),
          { col: o, y: this._getColGroupY(o, e) }
        );
      }),
      (i._manageStamp = function (e) {
        ...
        l = Math.max(0, l);
        var d = Math.floor(a / this.columnWidth);
        (d -= a % this.columnWidth ? 0 : 1), (d = Math.min(this.cols - 1, d));
        for (
          var p = this._getOption("originTop"),
            m = (p ? n.top : n.bottom) + o.outerHeight,
            c = l;
          c <= d;
          c++
        )
          this.colYs[c] = Math.max(m, this.colYs[c]);
      }),
  ...
  (function (e, t) {
    "function" == typeof define && define.amd
      ...
      : t(e.IsotopeWpr.LayoutMode, e.Masonry);
  })(window, function (e, t) {
    "use strict";
    var o = e.create("masonry"),
      i = o.prototype,
    ...
    i.measureColumns = function () {
      (this.items = this.isotopewpr.filteredItems), s.call(this);
    };
    var a = i._getOption;
    return (
      (i._getOption = function (e) {
        return "fitWidth" == e
          ...
          : a.apply(this.isotopewpr, arguments);
      }),
      o
    );
  }),
  ...
  (function (e, t) {
    ...
    return (
      ...
      (o._getItemLayoutPosition = function (e) {
        e.getSize();
        var t =
            (this.isotopewpr.size.innerWidth - e.size.outerWidth) *
  ...
  (function (e, t) {
    ...
    var l = e.jQuery,
      ...
      p = t.create("isotopewpr", {
        layoutMode: "masonry",
        isJQueryFiltering: !0,
        sortAscending: !0,
      });
    (p.Item = r), (p.LayoutMode = s);
    var m = p.prototype;
    (m._create = function () {
      ...
      (m._itemize = function () {
        for (
          var e, o = t.prototype._itemize.apply(this, arguments), n = 0;
          n < o.length;
          n++
        )
          (e = o[n]), (e.id = this.itemGUID++);
        return this._updateItemsSortData(o), o;
      }),
      (m._initLayoutMode = function (e) {
        var t = s.modes[e],
          o = this.options[e] || {};
        (this.options[e] = t.options ? n.extend(t.options, o) : o),
      ...
      (m._filter = function (e) {
        var t = this.options.filter;
        t = t || "*";
        for (
          var o, n = [], r = [], s = [], a = this._getFilterTest(t), l = 0;
          l < e.length;
          l++
        )
          if (((o = e[l]), !o.isIgnored)) {
            var d = a(o);
            d && n.push(o),
              d && o.isHidden ? r.push(o) : !d && !o.isHidden && s.push(o);
          }
        return { matches: n, needReveal: r, needHide: s };
      }),
      (m._getFilterTest = function (e) {
      ...
      (m.updateSortData = function (e) {
        var t;
        e ? ((e = n.makeArray(e)), (t = this.getItems(e))) : (t = this.items),
          this._getSorters(),
      ...
      (m._updateItemsSortData = function (e) {
        for (var t, o = e && e.length, n = 0; o && n < o; n++)
          (t = e[n]), t.updateSortData();
      });
    var c = (function () {
      function e(e, t) {
        return e
    ...
    (p.sortDataParsers = {
      ...
      (m._getItemLayoutPosition = function (e) {
        return this._mode()._getItemLayoutPosition(e);
      }),
      (m._manageStamp = function (e) {
      ...
      (m._filterRevealAdded = function (e) {
      ...
      (m.insert = function (e) {
        ...
        if (t.length) {
          var o,
            ...
            r = t.length;
          for (o = 0; o < r; o++)
            (n = t[o]), this.element.appendChild(n.element);
    ...
    return (
      (m.remove = function (e) {
        ...
        var t = this.getItems(e);
        u.call(this, e);
        for (var o, r = t && t.length, s = 0; r && s < r; s++)
          (o = t[s]), n.removeFrom(this.filteredItems, o);
      }),
      (m.shuffle = function () {
        for (var e, t = 0; t < this.items.length; t++)
          (e = this.items[t]), (e.sortData.random = Math.random());
        (this.options.sortBy = "random"), this._sort(), this._layout();
      }),
      (m._noTransition = function (e, t) {
  ...
  !(function (o, t) {
    "function" == typeof define && define.amd
      ...
      : "object" == typeof module && module.exports
      ? (module.exports = t(o, require("jquery")))
      : (o.jQueryBridget = t(o, o.jQuery));
  })(window, function (d, t) {
    "use strict";
    function e(s, c, g) {
      function o(i, l, e) {
        ...
        return (
          i.each(function (o, t) {
            ...
            if (!i)
              return void m(
                s + " not initialized. Cannot call methods, i.e. " + d
              );
            var r = i[l];
            if (!r || "_" == l.charAt(0))
              return void m(d + " is not a valid method");
            var a = r.apply(i, e);
            n = void 0 === n ? a : n;
          }),
          void 0 === n ? i : n
      ...
      function n(o, i) {
        o.each(function (e, t) {
          var n = g.data(t, s);
          n ? (n.option(i), n._init()) : ((n = new c(t, i)), g.data(t, s, n));
        });
      }
      (g = g || t || d.jQuery),
        g &&
          (c.prototype.option ||
            (c.prototype.option = function (e) {
              g.isPlainObject(e) &&
                (this.options = g.extend(!0, this.options, e));
            }),
          (g.fn[s] = function (r) {
            if ("string" == typeof r) {
  ...
  (function (o, t) {
    ...
    return (
      ...
      (t.off = function (o, t) {
        var e = this._events && this._events[o];
        if (e && e.length) {
          var i = e.indexOf(t);
          return -1 != i && e.splice(i, 1), this;
        }
      }),
      (t.emitEvent = function (a, t) {
        var l = this._events && this._events[a];
        if (l && l.length) {
          (l = l.slice(0)), (t = t || []);
          for (
            var d = this._onceEvents && this._onceEvents[a], n = 0;
            n < l.length;
            n++
          ) {
            var p = l[n],
              r = d && d[p];
            r && (this.off(a, p), delete d[p]), p.apply(this, t);
          }
          return this;
        }
      }),
  ...
  (function (o, t) {
    "function" == typeof define && define.amd
      ...
      : "object" == typeof module && module.exports
      ? (module.exports = t(o, require("desandro-matches-selector")))
      : (o.fizzyUIUtils = t(o, o.matchesSelector));
  })(window, function (d, s) {
    var p = {
        extend: function (o, t) {
      ...
      i = Array.prototype.slice;
    (p.makeArray = function (o) {
      if (Array.isArray(o)) return o;
      if (null === o || void 0 === o) return [];
      var t = "object" == typeof o && "number" == typeof o.length;
      return t ? i.call(o) : [o];
    }),
      (p.removeFrom = function (o, t) {
        var e = o.indexOf(t);
        -1 != e && o.splice(e, 1);
      }),
      (p.getParent = function (e, o) {
        for (; e.parentNode && e != document.body; )
          if (((e = e.parentNode), s(e, o))) return e;
      }),
      (p.getQueryElement = function (e) {
        return "string" == typeof e ? document.querySelector(e) : e;
      }),
      (p.handleEvent = function (o) {
        var t = "on" + o.type;
        this[t] && this[t](o);
      }),
      (p.filterFindElements = function (e, a) {
        e = p.makeArray(e);
        var n = [];
        return (
          e.forEach(function (e) {
      ...
      (p.debounceMethod = function (r, t, s) {
        s = s || 100;
        var a = r.prototype[t],
          n = t + "Timeout";
        r.prototype[t] = function () {
          ...
          var t = arguments,
            e = this;
          this[n] = setTimeout(function () {
            a.apply(e, t), delete e[n];
          }, s);
        };
      }),
      (p.docReady = function (o) {
        var t = document.readyState;
        "complete" == t || "interactive" == t
          ? setTimeout(o)
          : document.addEventListener("DOMContentLoaded", o);
      }),
      (p.toDashed = function (e) {
        return e
          .replace(/(.)([A-Z])/g, function (o, t, e) {
            return t + "-" + e;
          })
          .toLowerCase();
      });
    var e = d.console;
    return (
      (p.htmlInit = function (o, m) {
        p.docReady(function () {
          var t = p.toDashed(m),
            n = "data-" + t,
            i = document.querySelectorAll("[" + n + "]"),
            r = document.querySelectorAll(".js-" + t),
            s = p.makeArray(i).concat(p.makeArray(r)),
            l = d.jQuery;
          s.forEach(function (s) {
            var t,
              d = s.getAttribute(n) || s.getAttribute(n + "-options");
            try {
              t = d && JSON.parse(d);
            } catch (t) {
              return void (
                e &&
                e.error("Error parsing " + n + " on " + s.className + ": " + t)
              );
            }
            var r = new o(s, t);
            l && l.data(s, m, r);
  ...
  (function (o, t) {
    "function" == typeof define && define.amd
      ...
      : (o.InfiniteScroll = t(o, o.EvEmitter, o.fizzyUIUtils));
  })(window, function (d, t, p) {
    function m(o, i) {
      var e = p.getQueryElement(o);
      if (!e)
        return void console.error(
          "Bad element for InfiniteScroll: " + (e || o)
        );
      if (((o = e), o.infiniteScrollGUID)) {
        var r = n[o.infiniteScrollGUID];
        return r.option(i), r;
      }
      (this.element = o),
        (this.options = p.extend({}, m.defaults)),
        this.option(i),
    ...
    var c = d.jQuery,
      n = {};
    (m.defaults = {}), (m.create = {}), (m.destroy = {});
    var e = m.prototype;
    p.extend(e, t.prototype);
    var r = 0;
    (e.create = function () {
      var o = (this.guid = ++r);
      (this.element.infiniteScrollGUID = o),
        (n[o] = this),
        (this.pageIndex = 1),
        (this.loadCount = 0),
        this.updateGetPath();
      var t = this.getPath && this.getPath();
      if (!t) return void console.error("Disabling InfiniteScroll");
      for (var e in (this.updateGetAbsolutePath(),
      this.log("initialized", [this.element.className]),
      this.callOnInit(),
      m.create))
        m.create[e].call(this);
    }),
      (e.option = function (e) {
        p.extend(this.options, e);
      }),
      (e.callOnInit = function () {
        var e = this.options.onInit;
        e && e.call(this, this);
      }),
      (e.dispatchEvent = function (o, a, e) {
        this.log(o, e);
        var i = a ? [a].concat(e) : e;
        if ((this.emitEvent(o, i), c && this.$element)) {
          o += ".infiniteScroll";
          var n = o;
          if (a) {
            var l = c.Event(a);
    ...
    var s = {
      ...
      load: function (o, t) {
        return (o.title || "") + ". URL: " + t;
      },
      error: function (o, t) {
        return o + ". URL: " + t;
      },
      append: function (o, t, e) {
        return e.length + " items. URL: " + t;
      },
      last: function (o, t) {
        return "URL: " + t;
      },
      history: function (o, t) {
        return "URL: " + t;
      },
      pageIndex: function (o, t) {
        return "current page determined to be: " + o + " from " + t;
      },
    };
    (e.log = function (o, t) {
      if (this.options.debug) {
        var e = "[InfiniteScroll] " + o,
          r = s[o];
        r && (e += ". " + r.apply(this, t)), console.log(e);
      }
    }),
      (e.updateMeasurements = function () {
        this.windowHeight = d.innerHeight;
        var t = this.element.getBoundingClientRect();
        this.top = t.top + d.pageYOffset;
      }),
      (e.updateScroller = function () {
        var t = this.options.elementScroll;
        if (!t) return void (this.scroller = d);
        if (
          ((this.scroller = !0 === t ? this.element : p.getQueryElement(t)),
          !this.scroller)
        )
          throw "Unable to find elementScroll: " + t;
      }),
      (e.updateGetPath = function () {
        var o = this.options.path;
        if (!o)
          return void console.error(
            "InfiniteScroll path option required. Set as: " + o
          );
        var t = typeof o;
        if ("function" == t) return void (this.getPath = o);
        var e = "string" == t && o.match("{{#}}");
        return e
          ? void this.updateGetPathTemplate(o)
          : void this.updateGetPathSelector(o);
      }),
      (e.updateGetPathTemplate = function (o) {
        this.getPath = function () {
          var t = this.pageIndex + 1;
          return o.replace("{{#}}", t);
        }.bind(this);
        var t = o.replace("{{#}}", "(\\d\\d?\\d?)"),
          e = new RegExp(t),
          i = location.href.match(e);
        i &&
    ...
    return (
      (e.updateGetPathSelector = function (a) {
        var t = document.querySelector(a);
        if (!t)
          return void console.error(
            "Bad InfiniteScroll path option. Next link not found: " + a
          );
        for (
          var e, l, d = t.getAttribute("href"), o = 0;
          d && o < i.length;
          o++
        ) {
          l = i[o];
        ...
        return e
          ? ((this.isPathSelector = !0),
            (this.getPath = function () {
              var o = this.pageIndex + 1;
              return e[0] + o + e[2];
            }.bind(this)),
            (this.pageIndex = parseInt(e[1], 10) - 1),
            void this.log("pageIndex", [this.pageIndex, "next link"]))
          : void console.error(
              "InfiniteScroll unable to parse next link href: " + d
            );
      }),
      (e.updateGetAbsolutePath = function () {
        var o = this.getPath(),
          t = o.match(/^http/) || o.match(/^\//);
      ...
      (m.create.hideNav = function () {
        var e = p.getQueryElement(this.options.hideNav);
        e && ((e.style.display = "none"), (this.nav = e));
      }),
      (m.destroy.hideNav = function () {
        this.nav && (this.nav.style.display = "");
      }),
      (e.destroy = function () {
        for (var e in (this.allOff(), m.destroy)) m.destroy[e].call(this);
        delete this.element.infiniteScrollGUID,
          delete n[this.guid],
          c && this.$element && c.removeData(this.element, "infiniteScroll");
      }),
      (m.throttle = function (s, t) {
        t = t || 200;
        var a, l;
        return function () {
          var e = +new Date(),
          ...
          a && e < a + t ? (clearTimeout(l), (l = setTimeout(i, t))) : i();
        };
      }),
      (m.data = function (o) {
        o = p.getQueryElement(o);
        var i = o && o.infiniteScrollGUID;
        return i && n[i];
      }),
      (m.setJQuery = function (e) {
        c = e;
      }),
      p.htmlInit(m, "infinite-scroll"),
      (e._init = function () {}),
      c && c.bridget && c.bridget("infiniteScroll", m),
      m
    );
  }),
  (function (o, t) {
    "function" == typeof define && define.amd
      ...
      : "object" == typeof module && module.exports
      ? (module.exports = t(o, require("./core")))
      : t(o, o.InfiniteScroll);
  })(window, function (a, t) {
    function d(o) {
      for (
    ...
    function i(o) {
      for (var t = o.querySelectorAll("script"), e = 0; e < t.length; e++) {
        var s = t[e],
          n = document.createElement("script");
        l(s, n), (n.innerHTML = s.innerHTML), s.parentNode.replaceChild(n, s);
      }
    }
    function l(r, t) {
      for (var e, s = r.attributes, i = 0; i < s.length; i++)
        (e = s[i]), t.setAttribute(e.name, e.value);
    }
    function o(r, t, e, i) {
      ...
      n.open("GET", r, !0),
        ...
        (n.onload = function () {
          if (200 == n.status) e(n.response);
          else {
            var o = new Error(n.statusText);
            i(o);
          }
        }),
        (n.onerror = function () {
    ...
    return (
      ...
      (e.loadNextPage = function () {
        if (!this.isLoading && this.canLoad) {
          ...
          var t = function (t) {
            ...
            e = function (t) {
              this.onPageError(t, n);
            }.bind(this);
          o(n, this.options.responseType, t, e),
            this.dispatchEvent("request", null, [n]);
        }
      }),
      (e.onPageLoad = function (o, t) {
        return (
          this.options.append || (this.isLoading = !1),
          this.pageIndex++,
          this.loadCount++,
          this.dispatchEvent("load", null, [o, t]),
          this.appendNextPage(o, t),
          o
        );
      }),
      (e.appendNextPage = function (i, t) {
          ...
          var o = i.querySelectorAll(e),
            ...
            s = function () {
              this.appendItems(o, r),
                (this.isLoading = !1),
                this.dispatchEvent("append", null, [i, t, o]);
            }.bind(this);
          this.options.outlayer ? this.appendOutlayerItems(r, s) : s();
        }
      }),
      (e.appendItems = function (o, t) {
        o && o.length && ((t = t || d(o)), i(t), this.element.appendChild(t));
      }),
      (e.appendOutlayerItems = function (e, i) {
        var n = t.imagesLoaded || a.imagesLoaded;
        return n
          ? void n(e, i)
          : (console.error(
      ...
      (e.onAppendOutlayer = function (o, t, e) {
        this.options.outlayer.appended(e);
      }),
      (e.checkLastPage = function (a, t) {
        var e = this.options.checkLastPage;
        if (e) {
          var i = this.options.path;
          if ("function" == typeof i) {
            var n = this.getPath();
            if (!n) return void this.lastPageReached(a, t);
          }
          var o;
          if (
            ("string" == typeof e ? (o = e) : this.isPathSelector && (o = i),
            o && a.querySelector)
          ) {
            var l = a.querySelector(o);
            l || this.lastPageReached(a, t);
          }
        }
      }),
      (e.lastPageReached = function (o, t) {
        (this.canLoad = !1), this.dispatchEvent("last", null, [o, t]);
      }),
      (e.onPageError = function (o, t) {
        return (
          (this.isLoading = !1),
          (this.canLoad = !1),
          this.dispatchEvent("error", null, [o, t]),
          o
        );
      }),
  ...
  (function (o, t) {
    "function" == typeof define && define.amd
      ...
      : "object" == typeof module && module.exports
      ? (module.exports = t(o, require("./core"), require("fizzy-ui-utils")))
      : t(o, o.InfiniteScroll, o.fizzyUIUtils);
    ...
    return (
      ...
      (i.getWindowBottomDistance = function () {
        var t = this.top + this.element.clientHeight,
          e = o.pageYOffset + this.windowHeight;
        return t - e;
      }),
      (i.getElementBottomDistance = function () {
        var o = this.scroller.scrollHeight,
          t = this.scroller.scrollTop + this.scroller.clientHeight;
        return o - t;
      }),
      (i.onResize = function () {
        this.updateMeasurements();
    ...
    return (
      (t.create.history = function () {
        if (this.options.history) {
          ...
          var o = s.origin || s.protocol + "//" + s.host,
            t = o == location.origin;
          return t
      ...
      (i.onAppendHistory = function (o, t, e) {
        if (e && e.length) {
          var i = e[0],
            n = this.getElementScrollY(i);
          (s.href = t),
            this.scrollPages.push({ top: n, path: s.href, title: o.title });
        }
      }),
      ...
      (i.onScrollHistory = function () {
        for (
          var r, s, a, l = this.getScrollViewY(), i = 0;
          i < this.scrollPages.length &&
          ((a = this.scrollPages[i]), !(a.top >= l));
          i++
        )
          (r = i), (s = a);
        r != this.scrollPageIndex &&
          ((this.scrollPageIndex = r), this.setHistory(s.title, s.path));
      }),
      e.debounceMethod(t, "onScrollHistory", 150),
      (i.getScrollViewY = function () {
        return this.options.elementScroll
          ? this.scroller.scrollTop + this.scroller.clientHeight / 2
          : r.pageYOffset + this.windowHeight / 2;
      }),
      (i.setHistory = function (o, t) {
        var e = this.options.history,
          i = e && history[e + "State"];
        i &&
          (history[e + "State"](null, o, t),
          this.options.historyTitle && (document.title = o),
          this.dispatchEvent("history", null, [o, t]));
      }),
      (i.onUnload = function () {
        var t = this.scrollPageIndex;
        if (0 !== t) {
          var e = this.scrollPages[t],
            o = r.pageYOffset - e.top + this.top;
          this.destroyHistory(), scrollTo(0, o);
        }
      }),
      (i.onPageLoadHistory = function (o, t) {
        this.setHistory(o.title, t);
      }),
      t
    );
  }),
  (function (o, t) {
    ...
    return (
      (t.create.button = function () {
        var o = e.getQueryElement(this.options.button);
        if (o) return void (this.button = new i(o, this));
      }),
  ...
  (function (o, t) {
    ...
    return (
      (t.create.status = function () {
        var o = e.getQueryElement(this.options.status);
        o &&
          ((this.statusElement = o),
          (this.statusEventElements = {
            request: o.querySelector(".infinite-scroll-request"),
            error: o.querySelector(".infinite-scroll-error"),
            last: o.querySelector(".infinite-scroll-last"),
          }),
      ...
      (r.bindHideStatus = function (o) {
        var t = this.options.append ? "append" : "load";
        this[o](t, this.hideAllStatus);
      }),
      ...
      (r.showStatus = function (o) {
        n(this.statusElement), this.hideStatusEventElements();
        var t = this.statusEventElements[o];
        n(t);
      }),
      ...
      (r.hideStatusEventElements = function () {
        for (var o in this.statusEventElements) {
          var t = this.statusEventElements[o];
          i(t);
        }
      }),
  ...
  (function (o, t) {
    ...
    "function" == typeof define && define.amd
      ...
      : "object" == typeof module && module.exports
      ? (module.exports = t(o, require("ev-emitter")))
      : (o.imagesLoaded = t(o, o.EvEmitter));
  })("undefined" == typeof window ? this : window, function (d, t) {
    function p(o, t) {
      for (var e in t) o[e] = t[e];
      return o;
    }
    ...
    function n(o, t, e) {
      if (!(this instanceof n)) return new n(o, t, e);
      var a = o;
      return (
        "string" == typeof o && (a = document.querySelectorAll(o)),
        a
          ? ((this.elements = i(a)),
            (this.options = p({}, this.options)),
            "function" == typeof t ? (e = t) : p(this.options, t),
            e && this.on("always", e),
            this.getImages(),
            m && (this.jqDeferred = new m.Deferred()),
            void setTimeout(this.check.bind(this)))
          : void u.error("Bad element for imagesLoaded " + (a || o))
      );
    }
    function o(e) {
      this.img = e;
    ...
    function r(o, t) {
      (this.url = o), (this.element = t), (this.img = new Image());
    }
    var m = d.jQuery,
      u = d.console,
    ...
    (n.prototype = Object.create(t.prototype)),
      ...
      (n.prototype.addElementImages = function (l) {
        ...
        var t = l.nodeType;
        if (t && a[t]) {
          for (var e, d = l.querySelectorAll("img"), i = 0; i < d.length; i++)
            (e = d[i]), this.addImage(e);
    ...
    var a = { 1: !0, 9: !0, 11: !0 };
    return (
      (n.prototype.addElementBackgroundImages = function (r) {
        var t = getComputedStyle(r);
        if (t)
          for (
            var e, s = /url\((['"])?(.*?)\1\)/gi, i = s.exec(t.backgroundImage);
            null !== i;

          )
            (e = i && i[2]),
              e && this.addBackground(e, r),
              (i = s.exec(t.backgroundImage));
      }),
      (n.prototype.addImage = function (i) {
        var t = new o(i);
        this.images.push(t);
      }),
      (n.prototype.addBackground = function (o, t) {
        var e = new r(o, t);
        this.images.push(e);
      }),
        ...
        return (
          ...
          this.images.length
            ? void this.images.forEach(function (t) {
                t.once("progress", o), t.check();
              })
            : void this.complete()
        );
      }),
      (n.prototype.progress = function (o, t, e) {
        this.progressedCount++,
          (this.hasAnyBroken = this.hasAnyBroken || !o.isLoaded),
          this.emitEvent("progress", [this, o, t]),
          this.jqDeferred &&
            this.jqDeferred.notify &&
            this.jqDeferred.notify(this, o),
          this.progressedCount == this.images.length && this.complete(),
          this.options.debug && u && u.log("progress: " + e, o, t);
      }),
      (n.prototype.complete = function () {
        var o = this.hasAnyBroken ? "fail" : "done";
        if (
          ((this.isComplete = !0),
          this.emitEvent(o, [this]),
      ...
      (o.prototype.confirm = function (o, t) {
        (this.isLoaded = o), this.emitEvent("progress", [this, this.img, t]);
      }),
      (o.prototype.handleEvent = function (o) {
        var t = "on" + o.type;
        this[t] && this[t](o);
      }),
      ...
      (r.prototype.confirm = function (o, t) {
        (this.isLoaded = o),
      ...
      (n.makeJQueryPlugin = function (t) {
        (t = t || d.jQuery),
          t &&
            ((m = t),
            (m.fn.imagesLoaded = function (o, t) {
              var e = new n(this, o, t);
              return e.jqDeferred.promise(m(this));
            }));
      }),
      n.makeJQueryPlugin(),
      n

  ...
  (s = 0),
    ...
    (r.prototype.getSlideCount = function () {
      var s,
        ...
        r = this;
      return (
        (i = !0 === r.options.centerMode ? Math.floor(r.$list.width() / 2) : 0),
        (n = -1 * r.swipeLeft + i),
        !0 === r.options.swipeToSlide
          ? (r.$slideTrack.find(".slick-slide").each(function (i, e) {
              var t, o;
              if (
                ((t = a(e).outerWidth()),
                (o = e.offsetLeft),
            ...
            Math.abs(a(s).attr("data-slick-index") - r.currentSlide) || 1)
